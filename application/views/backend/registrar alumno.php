<div class="col-md-10 contenido">
    <?php if($this->uri->segment(3) == 'registrar' || !isset($imagen)):?>
        <img src ="<?= base_url();?>images/paginas/images.jpeg" class="foto hidden-xs hidden-sm" alt="foto de alumno">        
    <?php else:?>        
        <img src ="<?= $imagen;?>" class="foto hidden-xs hidden-sm" alt="foto de alumno">        
    <?php endif;?> 
    ...
    <?php foreach($formulario as $input): ?>
        <div class="form-group">
            ...
            <?php elseif($input['input']['name'] == "asignaturas"):?>
                <h4>Forma de pago</h4>
                <input type="radio" name="pago" value="contado" id="contado"><label>Al contado</label>    
                <input type="radio" name="pago" value="domiciliacion" id="domiciliacion"><label>Domiciliación bancaria</label>    
